...
//}
//
//void init_obstacle_detection(void){                       // Sets obstacles after a turn
//
...
//}
//
//void set_turning_direction(void) {                      // Finds initial turning direction, looks for a "shorter" side, or a slope
//
...
//        }
//
//        //If the e-puck is back on the main track and we advanced at least a little bit forward, then the obstacle is avoided
